...
% Different initial values for x0 (prey) and y0 (predators)
initial_conditions = [
    2, 10; %predators are much larger than preys 
    10, 2; %preys are much larger than predators 
    12, 12; %same number of preys and predators 
    15,5; %moderate difference between preys and predators 
    5,15; %moderate difference between preys and predators 
];
...
title('Predator-Prey Phase Plot for Different Initial Conditions');
grid on;
